...
keybindings = {
        'Mod4-p':lambda _: execute(program_menu()),
        'Mod4-j':lambda _: client.write('/tag/sel/ctl', 'select down'),
        'Mod4-k':lambda _: client.write('/tag/sel/ctl', 'select up'),
        'Mod4-h':lambda _: client.write('/tag/sel/ctl', 'select left'),
        'Mod4-l':lambda _: client.write('/tag/sel/ctl', 'select right'),
        'Mod4-Shift-j':lambda _: client.write('/tag/sel/ctl', 'send sel down'),
        'Mod4-Shift-k':lambda _: client.write('/tag/sel/ctl', 'send sel up'),
        'Mod4-Shift-h':lambda _: client.write('/tag/sel/ctl', 'send sel left'),
        'Mod4-Shift-l':lambda _: client.write('/tag/sel/ctl', 'send sel right'),
        'Mod4-d':lambda _: client.write('/tag/sel/ctl', 'colmode sel default-max'),
        'Mod4-s':lambda _: client.write('/tag/sel/ctl', 'colmode sel stack-max'),
        'Mod4-m':lambda _: client.write('/tag/sel/ctl', 'colmode sel stack+max'),
